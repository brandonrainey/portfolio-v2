  ...
  return (
    ...
    >
      ...
      <p className="border-l-4 pl-2 border-[#37448f]">
        ...
        impactful solutions. For the past two years, I&apos;ve been honing my skills
        in HTML, CSS, and JavaScript/TypeScript, with a focus on developing
        engaging websites and web applications using JavaScript and React.
      </p>
      <p className="border-l-4 pl-2 border-[#37448f]">
        A key project I&apos;m particularly proud of is a responsive e-commerce site
        I developed, featuring Stripe integration for seamless transactions and
        secure user authentication via Google OAuth. I utilized technologies
      ...
      <p className="border-l-4 pl-2 border-[#37448f]">
        ...
        self-taught programmer, I&apos;m a testament to self-motivation and have a
        love for learning new things - currently, I&apos;m learning Japanese.
      </p>
      <p className="border-l-4 pl-2 border-[#37448f]">
