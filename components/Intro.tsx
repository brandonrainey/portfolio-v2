    ...
    <div className="relative flex justify-around w-[75%] max-w-[800px] z-50 ">
      <div className="flex flex-col text-white bg-[#232041] p-4 rounded">
        ...
        <p className="text-[#bbbec3] lg:text-lg sm:text-base text-sm">
          a self-taught{' '}
          <span className="font-semibold text-[#9bc1e7]">
            Frontend Developer
          </span>{' '}
          ...
          <span className="font-semibold text-[#9bc1e7]">HTML</span>,{' '}
          <span className="font-semibold text-[#9bc1e7]">CSS</span>,{' '}
          <span className="font-semibold text-[#9bc1e7]">JavaScript</span>, and{' '}
          <span className="font-semibold text-[#9bc1e7]">React</span> to bring
